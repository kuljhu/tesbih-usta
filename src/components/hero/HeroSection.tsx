...
export default function HeroSection() {
  ...
  return (
    ...
    >
      {/* Katman 1 — arka zemin rengi + grain dokusu */}
      <motion.div
        style={{ y: bgY }}
      ...
      {/* Katman 2 — orta: altın yatay çizgi deseni */}
      <motion.div
        style={{ y: midY }}
      ...
      >
        <span className="text-[9px] uppercase tracking-[0.3em] text-muted/50">Kaydır</span>
        <motion.div
          animate={{ y: [0, 6, 0] }}
